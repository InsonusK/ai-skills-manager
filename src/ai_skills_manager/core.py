...
from .utils import is_managed, tag_managed, compute_hash
...
def copy_skill(mapping: SkillMapping, dry_run: bool) -> None:
...
class SkillSync:
    ...
    def sync(self) -> dict:
        ...
        for mapping in self.mappings:
            ...
            copy_skill(mapping, self.dry_run)
        ...
        return {
            'synced_count': len(self.mappings),
